...
var ASM_CONSTS = {
  2805149: ($0) => { globalThis.picorubyRefs[$0] = null; },  
 2805189: ($0) => { globalThis.picorubyRefs[$0] = true; },  
 2805229: ($0) => { globalThis.picorubyRefs[$0] = false; },  
 2805270: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2805308: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2805346: ($0, $1, $2) => { const str = UTF8ToString($1, $2); globalThis.picorubyRefs[$0] = str; },  
 2805419: ($0, $1) => { const arr = globalThis.picorubyRefs[$0]; const elem = globalThis.picorubyRefs[$1]; arr.push(elem); delete globalThis.picorubyRefs[$1]; },  
 2805558: ($0, $1, $2) => { const obj = globalThis.picorubyRefs[$0]; const key = UTF8ToString($1); const val = globalThis.picorubyRefs[$2]; obj[key] = val; delete globalThis.picorubyRefs[$2]; }
};

...
var ASM_CONSTS = {
  2842998: ($0) => { globalThis.picorubyRefs[$0] = null; },  
 2843038: ($0) => { globalThis.picorubyRefs[$0] = true; },  
 2843078: ($0) => { globalThis.picorubyRefs[$0] = false; },  
 2843119: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2843157: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2843195: ($0, $1, $2) => { const str = UTF8ToString($1, $2); globalThis.picorubyRefs[$0] = str; },  
 2843268: ($0, $1) => { const arr = globalThis.picorubyRefs[$0]; const elem = globalThis.picorubyRefs[$1]; arr.push(elem); delete globalThis.picorubyRefs[$1]; },  
 2843407: ($0, $1, $2) => { const obj = globalThis.picorubyRefs[$0]; const key = UTF8ToString($1); const val = globalThis.picorubyRefs[$2]; obj[key] = val; delete globalThis.picorubyRefs[$2]; }
};

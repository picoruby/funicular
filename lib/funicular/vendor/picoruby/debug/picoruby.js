...
var ASM_CONSTS = {
  2817113: ($0) => { globalThis.picorubyRefs[$0] = null; },  
 2817153: ($0) => { globalThis.picorubyRefs[$0] = true; },  
 2817193: ($0) => { globalThis.picorubyRefs[$0] = false; },  
 2817234: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2817272: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 2817310: ($0, $1, $2) => { const str = UTF8ToString($1, $2); globalThis.picorubyRefs[$0] = str; },  
 2817383: ($0, $1) => { const arr = globalThis.picorubyRefs[$0]; const elem = globalThis.picorubyRefs[$1]; arr.push(elem); delete globalThis.picorubyRefs[$1]; },  
 2817522: ($0, $1, $2) => { const obj = globalThis.picorubyRefs[$0]; const key = UTF8ToString($1); const val = globalThis.picorubyRefs[$2]; obj[key] = val; delete globalThis.picorubyRefs[$2]; }
};
